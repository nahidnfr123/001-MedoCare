...
var TableResultAction = function (startPoint, where, action, domTable) {
    ...
    /**
     * Get backend to be applied on the cell.
     *
     * @param {object} cell virtual table cell to apply backend
     */
    ...
    this.getActionList = function () {
        ...
        while (canContinue) {
            ...
            // Define backend to be applied in this cell
...
/**
*
* Where backend occours enum.
*/
TableResultAction.where = { 'Row': 0, 'Column': 1 };
/**
*
* Requested backend to apply enum.
*/
TableResultAction.requestAction = { 'Add': 0, 'Delete': 1 };
/**
*
* Result backend to be executed enum.
*/
    ...
    function AirPopover(context) {
        ...
        this.events = {
            ...
            'summernote.focusout': function (we, e) {
                ...
                //  - Ignore hide backend on focus out in FF.
                if (env.isFF) {
                    return;
                }
